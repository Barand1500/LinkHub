...
const ICONS = ['📁', '💻', '🌐', '📱', '🎨', '📚', '🔧', '🎵', '📷', '🎮', '💡', '⭐']
const COLORS = ['#8b5cf6', '#6366f1', '#ec4899', '#ef4444', '#f97316', '#eab308', '#22c55e', '#06b6d4', '#3b82f6']
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        ...
        <input
          ...
          placeholder="Örn: Frontend Kaynakları"
      ...
      <div>
        ...
        <textarea
          ...
          placeholder="Bu kategori ne içeriyor?"
          rows={2}
      ...
      <div className="flex items-center gap-3">
        ...
        <span className="text-sm">Herkese açık (paylaşılabilir)</span>
      </div>
